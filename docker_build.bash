DOCKER_BUILDKIT=1 docker build --secret id=env,src=.env -t arturoalcaniz/products-service:latest -t arturoalcaniz/products-service:$(npm pkg get version | tr -d '"') -f Dockerfile ..
if [ "$1" ]
  then
